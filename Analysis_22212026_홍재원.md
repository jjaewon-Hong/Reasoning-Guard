...
먼저 지휘통제실의 대형 모니터(TV) 인터페이스는 전장의 다채널 카메라 입력을 실시간으로 종합하여, 위협 수준(SAFE-CAUTION-DANGER)과 표적의 확률적 정체를 거시적으로 브리핑하는 **'종합 상황 인지 플랫폼'** 임.

<p align="center">
  <img src="./assets/그림5.png" width="49%" />
  <img src="./assets/그림6.png" width="49%" />
</p>
<p align="center">
  <em>[그림 5, 6] SAFE 상태 TV 및 PC 인터페이스 </em>
</p>

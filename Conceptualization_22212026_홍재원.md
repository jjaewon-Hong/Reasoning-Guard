...
| :---: | :--- |
| **Actor** | User (관제병) |
| **Description** | 연산된 신뢰도(Confidence Score)에 따라 SAFE, CAUTION, DANGER 3단계 상태를 UI에 도출하며, 예측 불확실성이 높을 경우 강제 HOLD 판정을 내려 관제병의 수동 확인을 유도함 |
...
| **Goals** | 시스템의 과신(Overconfidence)에 의한 오인 사격을 차단하고, CAUTION 단계에서 관제병의 능동적 개입(Manual Override)을 보장하여 인간 통제력을 유지함 |
